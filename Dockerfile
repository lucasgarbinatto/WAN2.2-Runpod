...
COPY wan-multi-ref-worker/handler.py /handler.py
COPY wan-multi-ref-worker/entrypoint.sh /entrypoint.sh
COPY wan-multi-ref-worker/new_Wan22_api.json /new_Wan22_api.json
COPY wan-multi-ref-worker/new_Wan22_flf2v_api.json /new_Wan22_flf2v_api.json
COPY wan-multi-ref-worker/new_Wan22_multiref_api.json /new_Wan22_multiref_api.json
COPY wan-multi-ref-worker/extra_model_paths.yaml /ComfyUI/extra_model_paths.yaml
